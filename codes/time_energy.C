...
void time_energy()
{
    ...
    h1->Draw("colz");
    canvases[0]->Update();
    snprintf(out1_name, NAME_LEN, "../exp%04d/a%04d/pdf/time_energy%d.pdf", exp_date, ana_date, channel + 1);
    canvases[0]->Print(out1_name);
    snprintf(out1_name, NAME_LEN, "../exp%04d/a%04d/img/time_energy%d.png", exp_date, ana_date, channel + 1);
    canvases[0]->Print(out1_name);

...
void draw_tdc_TQlowE()
{
    ...
    // graph titles
    htdc->SetTitle(Form("TDC Ch%d (E<450); time [ns]; count;", adc_channel + 1));
    ...
    snprintf(out_tdc_name, 64, "../exp%04d/a%04d/pdf/tdcTQ%dlowE.pdf", exp_date, ana_date, adc_channel + 1);
    canvases[0]->Print(out_tdc_name);
    snprintf(out_tdc_name, 64, "../exp%04d/a%04d/img/tdcTQ%dlowE.png", exp_date, ana_date, adc_channel + 1);
    canvases[0]->Print(out_tdc_name);

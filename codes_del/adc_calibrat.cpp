...
int adc_calibrat(double factor1, double ground1, double factor2, double ground2)
{
    ...
    snprintf(ifs_name, 64, "../exp%04d/a%04d/cut/exp%04d_tcalib.dat", exp_date, ana_date, exp_date);
    snprintf(ofs_name, 64, "../exp%04d/a%04d/cut/exp%04d_acalib.dat", exp_date, ana_date, exp_date);

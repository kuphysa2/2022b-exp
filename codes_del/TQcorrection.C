...
int TQcorrection()
{
    ...
    row = 0;
    char ifs_name[64];
    sprintf(ifs_name, "../exp%04d/a%04d/cut/exp%04d_acalib.dat", exp_date, ana_date, exp_date);
    ...
    char ofs_dt_name[64];
    sprintf(ofs_dt_name, "../exp%04d/a%04d/cut/dt%d.dat", exp_date, ana_date, adc_channel + 1);
    ...
    canvases[0]->Update();
    canvases[0]->Print(Form("../exp%04d/a%04d/cut/TQ_Tdistrib%d.pdf", exp_date, ana_date, adc_channel + 1));
    ...
    graph->Fit("f1");
    graph->Draw("AP");
    canvases[1]->Print(Form("../exp%04d/a%04d/cut/EdT%d.pdf", exp_date, ana_date, adc_channel + 1));
    ...
    // rewrite data
    char ofs_name[64];
    snprintf(ofs_name, 64, "../exp%04d/a%04d/cut/exp%04d_TQcor%d.dat", exp_date, ana_date, exp_date, adc_channel + 1);

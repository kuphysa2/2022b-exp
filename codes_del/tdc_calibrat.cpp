...
int tdc_calibrat(double factor = 0.246, double ground = -22.618)
{
    ...
    snprintf(ifs_name, 64, "../exp%04d/a%04d/cut/exp%04d_halved.dat", exp_date, ana_date, exp_date);
    snprintf(ofs_name, 64, "../exp%04d/a%04d/cut/exp%04d_tcalib.dat", exp_date, ana_date, exp_date);
